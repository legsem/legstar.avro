...
public class Flat01Record extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
  public static final org.apache.avro.Schema SCHEMA$ = new org.apache.avro.Schema.Parser().parse("{\"type\":\"record\",\"name\":\"Flat01Record\",\"namespace\":\"test.example\",\"fields\":[{\"name\":\"comNumber\",\"type\":\"long\"},{\"name\":\"comName\",\"type\":\"string\"},{\"name\":\"comAmount\",\"type\":{\"type\":\"bytes\",\"logicalType\":\"decimal\",\"precision\":7,\"scale\":2}}]}");
   ...
   */
  public Flat01Record(java.lang.Long comNumber, java.lang.CharSequence comName, java.math.BigDecimal comAmount) {
  ...
  /** Creates a new Flat01Record RecordBuilder */
  public static test.example.Flat01Record.Builder newBuilder() {
    return new test.example.Flat01Record.Builder();
  }
  
  /** Creates a new Flat01Record RecordBuilder by copying an existing Builder */
  public static test.example.Flat01Record.Builder newBuilder(test.example.Flat01Record.Builder other) {
    return new test.example.Flat01Record.Builder(other);
  }
  
  /** Creates a new Flat01Record RecordBuilder by copying an existing Flat01Record instance */
  public static test.example.Flat01Record.Builder newBuilder(test.example.Flat01Record other) {
    return new test.example.Flat01Record.Builder(other);
  }
  
  /**
   * RecordBuilder for Flat01Record instances.
   */
  public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<Flat01Record>
    implements org.apache.avro.data.RecordBuilder<Flat01Record> {
    ...
    private Builder() {
      super(test.example.Flat01Record.SCHEMA$);
    }
    
    /** Creates a Builder by copying an existing Builder */
    private Builder(test.example.Flat01Record.Builder other) {
      super(other);
    ...
    /** Creates a Builder by copying an existing Flat01Record instance */
    private Builder(test.example.Flat01Record other) {
            super(test.example.Flat01Record.SCHEMA$);
      if (isValidValue(fields()[0], other.comNumber)) {
        this.comNumber = data().deepCopy(fields()[0].schema(), other.comNumber);
        fieldSetFlags()[0] = true;
    ...
    /** Sets the value of the 'comNumber' field */
    public test.example.Flat01Record.Builder setComNumber(long value) {
    ...
    public test.example.Flat01Record.Builder clearComNumber() {
    ...
    /** Sets the value of the 'comName' field */
    public test.example.Flat01Record.Builder setComName(java.lang.CharSequence value) {
    ...
    public test.example.Flat01Record.Builder clearComName() {
      comName = null;
    ...
    /** Sets the value of the 'comAmount' field */
    public test.example.Flat01Record.Builder setComAmount(java.nio.ByteBuffer value) {
    ...
    public test.example.Flat01Record.Builder clearComAmount() {
      comAmount = null;
    ...
    @Override
    public Flat01Record build() {
      try {
        Flat01Record record = new Flat01Record();
